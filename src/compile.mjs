...
const inputPath = 'flowbite-icons/src'
const outputPath = 'layouts/partials/flowbite-icons'
...
if (files.length === 0) {
    logger.error('!!! Could not find the Flowbite Icons under "flowbite-icons/src". Make sure the Flowbite Icon submodule is cloned.')
    process.exit(1)
}
